...
# Extract year of nodes for coloring nodes in functino of year
...
nnode = np.round(nnode/nnode.max()*1000)

pos=nx.nx_agraph.graphviz_layout(G)
nx.draw_networkx_nodes(G, pos, node_size=nnode, arrows=True, node_color=nodeY, cmap=cm)
